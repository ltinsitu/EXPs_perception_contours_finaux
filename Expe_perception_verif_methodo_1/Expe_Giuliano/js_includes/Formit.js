...
jqueryWidget: {
    _init: function () {
        ...
        this.continueMessage = dget(this.options, "continueMessage", "Clicca qui per continuare");
        ...
        this.obligatoryErrorGenerator =
            dget(this.options, "obligatoryErrorGenerator",
                 function (field) { return "Il campo " + field + "\u2019 deve essere riempito."; });
        this.obligatoryCheckboxErrorGenerator =
            dget(this.options, "obligatoryCheckboxErrorGenerator",
                 function (field) { return "Devi spuntare il campo " + field + " per poter continuare."; });
        this.obligatoryRadioErrorGenerator =
            dget(this.options, "obligatoryRadioErrorGenerator",
                 function (field) { return "Devi selezionare una opzione per \u2018" + field + "\u2019."; });
